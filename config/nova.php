...
return [
    ...
    */
    ...
    'brand' => [
        'logo' => env('APP_ENV') === 'production'
            ? realpath(__DIR__ . '/../public/assets/logo-prd.svg')
            : realpath(__DIR__ . '/../public/assets/logo.svg'),

        'colors' => env('APP_ENV') === 'production'
            ? ["400" => "244, 100, 100, 0.5", "500" => "244, 100, 100", "600" => "244, 100, 100, 0.75"]
            : ["400" => "24, 182, 155, 0.5", "500" => "24, 182, 155", "600" => "24, 182, 155, 0.75"],
    ],

    /*
    |--------------------------------------------------------------------------
    | Nova Job Resource Class
    |--------------------------------------------------------------------------
    |
