<template>
    <div class="py-6 px-1 md:px-2 lg:px-6">
        <div class="mx-auto py-8 max-w-sm flex justify-center text-black">
            <svg class="h-8 h-6" viewBox="0 0 204 37" xmlns="http://www.w3.org/2000/svg">
                <defs>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-8 max-w-[25rem] mx-auto">
            ...
            <button @click="continueWithGoogle" class="w-full flex justify-center shadow relative bg-slate-500 hover:bg-slate-400 text-white dark:text-slate-200 w-full flex justify-center cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-3 w-full flex justify-center shadow relative bg-slate-500 hover:bg-slate-400 w-full flex justify-center" type="submit">
